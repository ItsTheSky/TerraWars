...
public enum GameGeneratorType {
    ...
    DIAMOND(Material.DIAMOND_BLOCK, "Diamond Generator", Colors.SKY, new GeneratorDrop(Material.DIAMOND, 30)),
    EMERALD(Material.EMERALD_BLOCK, "Emerald Generator", Colors.EMERALD, new GeneratorDrop(Material.EMERALD, 60)),
    AMETHYST(Material.AMETHYST_BLOCK, "Amethyst Generator", Colors.VIOLET, new GeneratorDrop(Material.AMETHYST_SHARD, 120)),
    ;
    ...
    GameGeneratorType(Material blockIcon, String displayName, List<TextColor> scheme, GeneratorDrop... drops) {
    ...
    GameGeneratorType(GeneratorDrop... drops) {
        this(Material.BARRIER, "Base Type", Colors.SLATE, drops);
    }
